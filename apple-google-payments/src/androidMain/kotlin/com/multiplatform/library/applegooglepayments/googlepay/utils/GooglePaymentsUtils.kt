package com.multiplatform.library.applegooglepayments.googlepay.utils
...
import com.multiplatform.library.applegooglepayments.googlepay.Constants
...
class GooglePaymentsUtils(private val config: GooglePayConfig) {
     ...
     */
    private val allowedCardNetworks = JSONArray(config.allowedCards)
     ...
     * See [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardAuthMethods = JSONArray(listOf(SupportedMethods.PAN_ONLY.name, SupportedMethods.CRYPTOGRAM_3DS.name))
    ...
    fun getPaymentDataRequest(priceCents: Long): JSONObject {
        ...
        val shippingCountryCodeList = shippingDetails?.shippingCountryCodeList ?: emptyList()
